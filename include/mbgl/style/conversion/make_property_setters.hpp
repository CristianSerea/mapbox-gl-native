...
auto makePaintPropertySetters() {
    ...
    result["line-floorwidth"] = &setProperty<V, LineLayer, DataDrivenPropertyValue<float>, &LineLayer::setLineFloorwidth>;
    result["line-floorwidth-transition"] = &setTransition<V, LineLayer, &LineLayer::setLineFloorwidthTransition>;
